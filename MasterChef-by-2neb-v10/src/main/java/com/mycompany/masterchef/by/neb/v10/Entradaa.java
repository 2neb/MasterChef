...
public class Entradaa {
    ...
    public void MiEntrada()
    {
                            ...
                            Tabla11.addColumn("Entrada");
                            

                            // Agregar filas al modelo de datos
                            Tabla11.addRow(new Object[]{"Jorge Rausch", "Criterión", "Bogotá","Pulpo al Olivo"});
                            Tabla11.addRow(new Object[]{"Nicolás de Zubiría", "Kong", "Cartagena", "Carpaccio de Salmon"});
                            Tabla11.addRow(new Object[]{"Christopher Carpentier", "Patrón Bistro", "Santiago de Chile", "Sopa de tomate"});
