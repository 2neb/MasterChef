...
public class TiempoPrepara {
 
    
public TiempoPrepara()
{
...
{
                            JFrame Menu11 = new JFrame("Tiempo de preparación - Uso de JTable | Politecnico Internacional");
                            ...
                            Tabla11.addColumn("Tiempo de preparación");
                            

                            // Agregar filas al modelo de datos
                            Tabla11.addRow(new Object[]{"Jorge Rausch", "Criterión", "Bogotá","35 minutos"});
                            Tabla11.addRow(new Object[]{"Nicolás de Zubiría", "Kong","Cartagena", "30 minutos"});
                            Tabla11.addRow(new Object[]{"Christopher Carpentier", "Patrón Bistro", "Santiago de Chile", "35 minutos"});
