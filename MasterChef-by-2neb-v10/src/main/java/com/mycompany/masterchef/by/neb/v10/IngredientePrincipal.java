...
// Ciclo: 3 
 */
public class IngredientePrincipal {

public IngredientePrincipal()
{
    
}


public void MiIngrediente()
{
                            JFrame Menu11 = new JFrame("Ingrediente principal - Uso de JTable | Politecnico Internacional");
                            ...
                            Tabla11.addColumn("Ingrediente Principal");
                            

                            // Agregar filas al modelo de datos
                            Tabla11.addRow(new Object[]{"Jorge Rausch", "Criterión", "Bogotá", "Carne - Lomo y costilla"});
                            Tabla11.addRow(new Object[]{"Nicolás de Zubiría", "Kong", "Cartagena", "Pasta - Mariscos"});
                            Tabla11.addRow(new Object[]{"Christopher Carpentier", "Patrón Bistro", "Santiago de Chile", "Carne - Lomo - Pimienta y queso azul"});
